...
class Evatix_Artists_Block_Adminhtml_Artists_Edit_Tab_Configaration extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
        ...
        $fieldset = $form->addFieldset('configaration_fieldset',
                        array(
        ...
        $fieldset->addField('configaration', 'editor', array(
            'name' => 'configaration',
