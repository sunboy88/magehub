...
class Evatix_Banner_Block_Adminhtml_Banner_Edit_Tab_Main extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
        ...
        $fieldset = $form->addFieldset('base_fieldset',
                        array(
                            'legend' => Mage::helper('artists')->__('Banner Information')
                        )
        );
    ...
    public function getTabLabel() {
        return Mage::helper('artists')->__('Banner Information');
    }
